...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">SALES PERSON PASSWORD CHANGE</h4>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Sales Person Password - Update </h4>
              
                <form action="{{route('sales.person.password.update')}}" method="post">
                    @csrf
